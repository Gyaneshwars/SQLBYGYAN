...
SET @frDate = '2022-07-27 00:00:00.000'
SET @toDate = '2022-09-30 23:59:59.999' 
...
,PEO=dbo.formatPeriodId_fn(ed.estimatePeriodId) INTO #Estdt
...
a.languageName AS cur_lang,b.versionId AS prev_vid,b.dataItemName AS prev_din,b.peo AS prev_peo,b.dataItemValue AS prev_value,b.effectiveDate AS prev_Filingdate,a.contributor AS prev_contributor,
...
AND DATEDIFF(DAY,b.effectiveDate,a.effectiveDate)<=30



SELECT DISTINCT companyId,cur_contributor,cur_vid,cur_lang,prev_vid,Prev_lang,cur_Filingdate,prev_Filingdate,cur_din,cur_peo,cur_value,prev_value,cur_issueSource,Prev_issueSource FROM #EstdtFinal
ORDER BY cur_vid,cur_din


SELECT DISTINCT companyId,cur_contributor,cur_vid,prev_vid,cur_lang,cur_Filingdate,prev_Filingdate,cur_issueSource FROM #EstdtFinal WHERE cur_issueSource LIKE '%Estimates - Screening Research Documents%'
ORDER BY cur_vid